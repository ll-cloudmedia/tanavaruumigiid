(function() {
  ...
  function initMatrix() {
    ...
    container.id = 'street-types-matrix';
    ...
    container.innerHTML = `
      <div class="matrix-container">
        ...
        <div class="matrix-grid">
          <!-- Rida 1: Kõrge liikuvus (Ühendustänavad) -->
          ...
          <!-- Rida 2: Keskmine liikuvus (Jaotustänavad) -->
          ...
          <!-- Rida 3: Madal liikuvus (Kodutänavad) -->
    ...
    // Lisame CSS-i ja HTML-i lehele
    document.head.appendChild(style);
    
    // Otsime kohta, kuhu lisada (või lisame body lõppu)
    const targetElement = document.querySelector('.notion-page-content') || 
